...
export const TIER1_PRIORITY_LINKS: Tier1Link[] = [
  ...
  {
    href: "/guides/complete-guide-to-locum-cardiology",
    title: "Complete guide to locum cardiology",
    shortTitle: "Locum cardiology guide",
    description: "Subspecialty realities, IMLC, credentialing, contracts, pay, taxes, and a 90-day start plan.",
    ctaLabel: "Read the guide →",
  },
  {
    href: "/resources/things-nobody-tells-you-cardiology-fellowship",
    title: "Things nobody tells you during cardiology fellowship",
    shortTitle: "Fellowship truths",
    description: "Job search timing, call culture, RVUs, money anxiety, and career options—written for fellows.",
    ctaLabel: "Read essay →",
  },
  {
    href: "/guides/evaluate-first-cardiology-job-offer",
    title: "Evaluate your first cardiology job offer",
    shortTitle: "First job offer scorecard",
    description: "Schedule, volume, partners, exit terms, and money—not base-salary theater.",
    ctaLabel: "Read scorecard →",
  },
  {
    href: "/guides/physician-autonomy-vs-salary",
    title: "Autonomy vs salary after year three",
    shortTitle: "Autonomy vs salary",
    description: "Why schedule control often compounds more than another raise.",
    ctaLabel: "Read essay →",
  },
  {
