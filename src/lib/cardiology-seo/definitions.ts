...
export const SALARY_PAGE_DEFS: PageDef[] = [
  ...
  { category: "salary", slug: "electrophysiologist-salary", h1: "Electrophysiologist Salary", title: "Electrophysiologist Salary | Locums vs Employed Pay", description: "EP salary vs locums: $2,800–$3,200/day directional locum range, ablation vs device clinic, NY and Tennessee markets. Educational—not an offer.", topic: "electrophysiologist salary", keywords: ["electrophysiologist salary", "EP cardiologist compensation", "electrophysiology locums"] },
