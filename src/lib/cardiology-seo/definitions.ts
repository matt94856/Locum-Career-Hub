...
export const SALARY_PAGE_DEFS: PageDef[] = [
  ...
  { category: "salary", slug: "electrophysiologist-salary", h1: "Electrophysiologist Salary", title: "Electrophysiologist Salary | Locums vs Employed EP Pay", description: "Electrophysiologist salary and EP locums pay drivers—ablation weeks vs device clinic, call, and lab mix. Request cardiology matches after you compare ranges.", topic: "electrophysiologist salary", keywords: ["electrophysiologist salary", "EP cardiologist compensation", "electrophysiology locums"] },
...
export const PILLAR_PAGE_DEFS: PageDef[] = [
  { category: "pillar", slug: "complete-guide-to-locum-cardiology", h1: "Complete Guide to Locum Cardiology", title: "Cardiology Locums: The Complete Guide for MD/DO Cardiologists (2026)", description: "Physician-grade guide to cardiology locums—subspecialty realities, IMLC, credentialing timelines, contracts, pay drivers, taxes, and a 90-day start plan. Not recruiter mythology.", topic: "complete locum cardiology guide", keywords: ["cardiology locums guide", "complete guide locum cardiology", "locum cardiology guide"] },
