    ...
    <>
      ...
      <CardiologyCompensationGuide
        ...
        sections={[
          ...
          { heading: "Semi-retirement and late-career design", paragraphs: ["Part-time locums can be a glidepath: selective consult or clinic scope, capped travel, and recovery weeks. Write non-negotiables before you shop rates.", "See the semi-retired cardiologist locums guide for a fuller framework."] },
        ]}
        faqs={FAQS}
        path={PATH}
      />
