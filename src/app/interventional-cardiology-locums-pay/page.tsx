  ...
  return (
    <>
      ...
      <CardiologyCompensationGuide
        ...
        directAnswer="Interventional locums are typically $3,200–$3,500 per day. 24-hour STEMI call usually includes 0–4 hours; extra callback is daily ÷ 8 and can add more at a busy facility. A weekend is 2–3 of those days—not a $19k–$28k week."
        sections={[
          { heading: "Directional daily benchmark", paragraphs: ["Interventional locums are modeled at $3,200–$3,500 per day. A 24-hour call day typically includes 0–4 hours of work; extra callback is usually that daily rate divided by 8. If the assignment is not 24-hour call, the same daily rate applies, plus a one-time pager fee of daily ÷ 8 when night call is required. A weekend is 2–3 call days—not a 7-day coverage week."], bullets: ["Confirm guaranteed coverage pay and callback terms", "Document STEMI activation and backup", "Ask whether post-call relief is protected", "Separate travel/housing from clinical compensation"] },
          ...
          { heading: "Compare to general cardiology carefully", paragraphs: ["IC premiums often reflect nights and activation risk—not a free raise. Model recoverability and malpractice alignment the same way you would for employed STEMI call.", "See the interventional locums hub and career guide for scope and lifestyle framing beyond pay bands."] },
        ]}
        faqs={FAQS}
        path={PATH}
      />
