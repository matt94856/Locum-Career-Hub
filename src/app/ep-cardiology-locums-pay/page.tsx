    ...
    <>
      ...
      <CardiologyCompensationGuide
        ...
        sections={[
          ...
          { heading: "Lifestyle filter for EP locums", paragraphs: ["Remote monitoring and device clinic burden can erase the benefit of 'no STEMI.' Bound after-hours expectations in writing the same way you would bound call.", "See the electrophysiology locums hub for workflow and career-design context."] },
        ]}
        faqs={FAQS}
        path={PATH}
      />
