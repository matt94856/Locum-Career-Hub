    ...
    <>
      ...
      <CardiologyCompensationGuide
        ...
        sections={[
          ...
          { heading: "When to get clinical support first", paragraphs: ["If you are in crisis, unsafe, or unable to function, prioritize licensed clinical help and crisis resources before career redesign. Career pages are not treatment.", "In the U.S., call or text 988 if you may be in danger or need urgent support."] },
        ]}
        faqs={FAQS}
        path={PATH}
      />
