    ...
    <>
      ...
      <CardiologyCompensationGuide
        ...
        sections={[
          ...
          { heading: "Pay rankings without lifestyle mythology", paragraphs: ["Highest-paying lists often hide call intensity and cost of living. Use them as a shortlist for diligence—then compare written scopes.", "Pair this page with state salary guides and the locums calculator before resigning from employed work."] },
        ]}
        faqs={FAQS}
        path={PATH}
      />
