    ...
    <>
      ...
      <CardiologyCompensationGuide
        ...
        sections={[
          ...
          { heading: "How to use our tools without self-deception", paragraphs: ["Use the cardiologist locums calculator and public pay report as directional ranges. Then diligence the site: backup, EHR burden, and whether recurrence is likely enough to justify privileging time.", "Educational modeling is not a guaranteed offer—market conditions and written contracts decide."] },
        ]}
        faqs={FAQS}
        path={PATH}
      />
